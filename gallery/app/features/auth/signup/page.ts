    ...
    <div class="max-w-md mx-auto">
      ...
      <form action=${signup} class="${cardClass()} grid gap-4 p-5">
        <div class="grid gap-1.5">
          ...
          ${errors.name ? html`<p class="m-0 text-xs text-destructive">${errors.name}</p>` : ''}
        </div>
        <div class="grid gap-1.5">
          ...
          ${errors.email ? html`<p class="m-0 text-xs text-destructive">${errors.email}</p>` : ''}
        </div>
        <div class="grid gap-1.5">
          ...
          ${errors.password ? html`<p class="m-0 text-xs text-destructive">${errors.password}</p>` : ''}
        </div>
