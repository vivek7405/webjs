...
lib/
  ...
  check-target.js        PURE invocation-target guard for `webjs check` (#1301).
                         ...
                         message with the member directories that ARE apps. Test:
                         `test/cli/check-target.test.mjs`.
