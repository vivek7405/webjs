  ...
  return html`
    ...
    <section class="py-16">
      <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="hero-stage max-w-6xl mx-auto grid grid-cols-1 wide:grid-cols-[0.92fr_1.08fr] rounded-2xl overflow-hidden border border-border-strong bg-bg-sunken shadow-[var(--shadow)]">
