...
const FEATURES = [
  ...
  { icon: '🧱', title: 'Web Components First', desc: 'Less is more: only hooks with no native workaround (render, setState, firstUpdated, renderError). Reactive controllers for composition. Context protocol for shared state. Both shadow DOM and light DOM are fully SSR\'d (Declarative Shadow DOM / direct HTML) and hydrate with zero flash.' },
