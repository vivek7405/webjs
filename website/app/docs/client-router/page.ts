...
export default function ClientRouter() {
  return html`
    ...
    <ol>
      ...
      <li>The <code>&lt;head&gt;</code> is add-only merged (preserves runtime-injected styles like Tailwind's), <code>&lt;script&gt;</code> tags re-execute, and custom elements upgrade.</li>
