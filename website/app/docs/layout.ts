 ...
 * lib/utils/ui/docs-shell.ts, shared with the component library at /ui, so the two
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    // these pages (see lib/utils/ui/docs-shell.ts). This entry is a cross-link out of
