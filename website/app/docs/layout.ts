...
import { docsShell } from '#lib/utils/ui.ts';
 ...
 * lib/utils/ui.ts, shared with the component library at /ui, so the two
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    // these pages (see lib/utils/ui.ts). This entry is a cross-link out of
