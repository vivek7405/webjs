...
/** The shape the server sends: the code already projected into the <pre>. */
const ssrMarkup = (code, attrs = '') =>
  `<code-block${attrs}><pre tabindex="0"><code><slot data-webjs-light>${code
    .replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')}</slot></code></pre></code-block>`;
