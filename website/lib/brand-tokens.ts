 ...
 * exists: amber at 0.7 lightness takes near-black text, amber at 0.54 takes
 * white.
 */
export const ACCENTS: Swatch[] = [
  { token: '--accent', name: 'Amber', role: 'Primary button, closing CTA', dark: 'oklch(0.7 0.16 52)', light: 'oklch(0.54 0.16 52)' },
  { token: '--accent-fg', name: 'On amber', role: 'Text and icons on the accent', dark: 'oklch(0.1 0.01 52)', light: 'oklch(1 0 0)' },
  { token: '--accent-live', name: 'Live', role: 'Glow, live dots, focus rings', dark: 'oklch(0.63 0.17 50)', light: 'oklch(0.63 0.17 50)' },
];
