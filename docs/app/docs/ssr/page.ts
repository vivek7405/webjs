...
async function loadExpensiveItems() {
  ...
  return html\`&lt;ul&gt;\${items.map(i =&gt; html\`&lt;li&gt;\${i.name}&lt;/li&gt;\`)}&lt;/ul&gt;\`;
    ...
    <ol>
      <li>The class is registered via <code>customElements.define()</code> .</li>
...
export const metadata = {
  ...
  return {
    ...
    <p>Component preload discovery works because <code>customElements.define()</code> records the module URL alongside the tag name. During <code>injectDSD</code>, every custom element tag that matched is added to a <code>usedComponents</code> set. After rendering, the set is converted to <code>&lt;link&gt;</code> tags.</p>
