...
export default function Directives() {
  return html`
    ...
    <pre>import { repeat } from 'webjs';            // keyed lists
import { unsafeHTML, live } from 'webjs/directives'; // raw HTML, input sync</pre>
    ...
    <pre>import { html, repeat } from 'webjs';
...
&lt;/ul&gt;\`;</pre>
    ...
    <pre>import { unsafeHTML } from 'webjs/directives';
...
html\`&lt;article&gt;\${unsafeHTML(markdownToHtml(post.body))}&lt;/article&gt;\`;</pre>
    ...
    <pre>import { live } from 'webjs/directives';
