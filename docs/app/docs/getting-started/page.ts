...
export default function GettingStarted() {
  return html`
    ...
    <p>webjs is a <strong>AI-first, batteries-included, opinionated</strong> web framework inspired by NextJs, Lit, and Rails. You can use it as a full-stack framework with server-rendered pages, or as a lightweight backend-only API framework — the same file conventions work either way.</p>
